...
var onClickAdd = function onClickAdd() {
  ...
  document.getElementById("add-text").value = ""; //リスト追加の共通関数に置き換えてテキストはテキストボックスの入力したテキスト(inputText)を取得
...
var createIncompleteList = function createIncompleteList(text) {
  ...
  completeButton.addEventListener("click", function () {
    ...
    deleteFromIncompleteList(completeButton.parentNode); // 共通関数化前の記述
    ...
    var li = document.createElement("li");
    li.innerText = text; //　complete-areaのbuttonタグ生成
    ...
    addTarget.appendChild(backButton); //完了リストの<ul class="complete-list">配下に追加
  ...
  deleteButton.addEventListener("click", function () {
    //押された削除ボタンの親タグ(div)を未完了のリストから削除(共通の関数化で書き換え)
    deleteFromIncompleteList(deleteButton.parentNode); // 共通関数化前の記述
